...
import { applyFilterDirect } from '@/lib/filters'
import { processSchema } from '@/lib/variables/schema'
import { processSelector, resolveSelector } from '@/lib/variables/selector'
import { processSimpleVariable } from '@/lib/variables/simple'
 ...
 * Handles special variable types: selector, schema.
 *
